...
export const featuresApi = {
  getByProject: (
    ...
    apiClient.get<ApiResponse<Feature[]>>(`/features/project/${projectId}`, {
      params,
    }),
...
export const tasksApi = {
  getByProject: (
    projectId: string,
    params?: { status?: string; priority?: string; featureId?: string },
  ) =>
  ...
  delete: (id: string) => apiClient.delete<ApiResponse<null>>(`/tasks/${id}`),
